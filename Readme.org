...
For =gptel= integration, use [[https://github.com/lizqwerscott/gptel-mcp.el][gptel-mcp]] to enable MCP server tools in GPTel. See the =gptel-mcp= homepage for details.
